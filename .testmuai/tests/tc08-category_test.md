...
# Session: tc08-category

## Step 1
Go to http://localhost:5000/category/athletic. Assert that the page displays athletic shoes. Assert that product cards with shoe names and prices are visible.
